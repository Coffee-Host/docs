...
<Steps>
    ...
    ![排程頁面](/images/practice/automation/schedules.png)
    ...
    點擊「**創建排程**」，設定：
    - **名稱**：每日重啟
    - **時間**：例如每天凌晨 4:00，就輸入 **0 4 \* \* \***
    ![創建排程](/images/practice/automation/schedules2.png)
    ...
    點擊「**管理排程**」後點擊「**新工作**」，在排程中新增以下任務：

    1. **傳送指令**：`say 伺服器將在 5 分鐘後重啟！`
    2. **傳送電源操作**：重啟伺服器，時間偏移設為 300

    ![排程任務](/images/practice/automation/schedule-tasks.png)
